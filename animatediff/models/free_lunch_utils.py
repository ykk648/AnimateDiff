# 23.10.20 ykk648 mod from https://github.com/ChenyangSi/FreeU/blob/main/demo/free_lunch_utils.py
import torch
...
def register_free_upblock2d(model, b1=1.2, b2=1.4, s1=0.9, s2=0.2):
    def up_forward(self):
        def forward(hidden_states, res_hidden_states_tuple, temb=None, upsample_size=None, encoder_hidden_states=None):
